...
class DiaryViewmodel (
     ...
     *
     * @param description - This is the new description for the diary
     */
     ...
     *
     * @param imageUri - This is the new image for the diary. This image
     ...
     *
     * @param imageUrl - This is the new image for the diary. This image
    ...
    /**
     * This method adds the user inputted diary data to the Ui State, which can be added
     * to the database.
     *
     * @param diary - This is the new diary the user inputted, that will be used to either
     * add a new diary, or update an existing diary by replacing the diary in question with
     * the user inputted diary.
     */
    ...
    /**
     * This method is usually triggered if a diary is successfully added or updated. It allows
     * new diaries to be added, or existing diaries to be updated.
     */
    ...
    /**
     * This method resets the state of the data class "Diary Ui State", which is useful for
     * when the user is not viewing a diary. Another diary can be selected with new data displayed.
...
/**
 * This holds the diary information that the user inputted or selected, which can then be used to
 * add a diary, display the diary information to the screen, or even update the diary.
 */
